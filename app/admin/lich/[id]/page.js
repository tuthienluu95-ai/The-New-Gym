    ...
    <div className="stack">
      ...
      <div className="card">
        <form action={suaLich} className="stack" style={{ maxWidth: 460 }}>
          ...
          <div><label>Giờ bắt đầu</label><input type="time" name="gio_bat_dau" defaultValue={(l.gio_bat_dau || '').slice(0, 5)} required /></div>
          <div><label>Giờ kết thúc</label><input type="time" name="gio_ket_thuc" defaultValue={(l.gio_ket_thuc || '').slice(0, 5)} required /></div>
